...
moduleForModel('i-i-s-laboratornaya-rabota-stacionar-2-спр-сотр', 'Unit | Serializer | i-i-s-laboratornaya-rabota-stacionar-2-спр-сотр', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-laboratornaya-rabota-stacionar-2-спр-сотр',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
