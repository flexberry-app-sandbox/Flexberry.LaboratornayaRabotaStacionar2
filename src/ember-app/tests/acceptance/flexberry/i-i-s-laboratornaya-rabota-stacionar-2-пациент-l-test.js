...
moduleForAcceptance('[AGAT] Acceptance | i i s laboratornaya rabota stacionar 2 пациент l');

test('testing i-i-s-laboratornaya-rabota-stacionar-2-пациент-l', function(assert) {
