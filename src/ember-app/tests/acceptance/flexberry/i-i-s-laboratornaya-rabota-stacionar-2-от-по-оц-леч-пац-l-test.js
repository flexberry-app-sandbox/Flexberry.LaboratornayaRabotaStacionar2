...
moduleForAcceptance('[AGAT] Acceptance | i i s laboratornaya rabota stacionar 2 от по оц леч пац l');

test('testing i-i-s-laboratornaya-rabota-stacionar-2-от-по-оц-леч-пац-l', function(assert) {
