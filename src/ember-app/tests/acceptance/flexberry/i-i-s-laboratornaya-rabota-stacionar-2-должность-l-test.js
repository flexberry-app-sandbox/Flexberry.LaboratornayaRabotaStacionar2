...
moduleForAcceptance('[AGAT] Acceptance | i i s laboratornaya rabota stacionar 2 должность l');

test('testing i-i-s-laboratornaya-rabota-stacionar-2-должность-l', function(assert) {
