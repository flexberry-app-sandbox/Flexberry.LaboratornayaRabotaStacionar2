...
moduleForAcceptance('[AGAT] Acceptance | i i s laboratornaya rabota stacionar 2 ит отч по лет l');

test('testing i-i-s-laboratornaya-rabota-stacionar-2-ит-отч-по-лет-l', function(assert) {
