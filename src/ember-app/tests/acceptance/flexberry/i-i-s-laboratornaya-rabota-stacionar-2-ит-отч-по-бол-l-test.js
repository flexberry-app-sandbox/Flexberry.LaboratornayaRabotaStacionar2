...
moduleForAcceptance('[AGAT] Acceptance | i i s laboratornaya rabota stacionar 2 ит отч по бол l');

test('testing i-i-s-laboratornaya-rabota-stacionar-2-ит-отч-по-бол-l', function(assert) {
