...
moduleForAcceptance('[AGAT] Acceptance | i i s laboratornaya rabota stacionar 2 спр сотр l');

test('testing i-i-s-laboratornaya-rabota-stacionar-2-спр-сотр-l', function(assert) {
